...
echo ""
echo "- Enable/Start Load Generator:       \033[32mkubectl apply -f $K8S_DIR/09-load-generator.yaml\033[0m"
echo "- Stop/Remove Load Generator:        \033[32mkubectl delete -f $K8S_DIR/09-load-generator.yaml\033[0m (This removes the deployment and stops the traffic.)"
echo ""
